...
function gameOver() {
    ...
    if (score > highScore) {
        ...
        highScoreElement.textContent = highScore;
        modalMessage.textContent = 'New High Score! Try again?';
    } else {
        modalMessage.textContent = `Game Over! Your score was ${score}.`;
    }
...
function setupListeners() {
    ...
    exitButton.addEventListener('click', () => {
        // This is the standard way to programmatically close a tab/window.
        // NOTE: Browsers often prevent this for windows not opened by script,
        // but it's the correct implementation for an 'Exit' button.
        window.close();
    });
}

// Show the initial start screen when the script loads
modal.style.display = 'flex';
setupListeners();