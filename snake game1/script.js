...
function exitGame() {
    alert('Exiting Game. Thanks for playing!');
    // In a real application, you might redirect the user:
    // window.location.href = 'another_page.html';
    // For a local Snake game, we'll just reset and optionally hide controls.
    resetGame();
}
